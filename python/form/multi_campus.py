...
from evalio.datasets.base import (
    Dataset,
    DatasetIterator,
    get_data_dir,
)
...
class MultiCampusCustom(Dataset):
    ...
    def folder(self) -> Path:
        return get_data_dir() / "multi_campus" / self.seq_name
    ...
    def imu_params(self) -> ImuParams:
        # TODO: These are the only values I've changed from the default
        # The NTU sequences use the ATV platform and a VectorNav vn100 IMU
        ...
        # Handheld (KTH, TUHH) - vn200
        else:
            print("Using vn200 params")
            return ImuParams(
                # gyro=0.000416,  # discrete
                # # gyro=2.08e-05,  # continuous
                # accel=0.002498,  # discrete
                # # accel=0.0001249,  # continuous
                # gyro_bias=4e-7,
                # accel_bias=1.06e-5,
                gyro=5e-3,
                gyro_bias=3e-6,
